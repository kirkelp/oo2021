...
public class StreamsExample {
    public static void main(String[] args) {
        ...
        // System.out.println(IntStream.of(2,4,6,8,10)
        //     .allMatch(e->e%2==0));

        // System.out.println(IntStream.of(2,4,3,6,8,10)
        //     .anyMatch(e->e % 2 !=0));
        ...
        // IntStream.of(1,2,3,4).filter(e-> e < 10).min().ifPresent(System.out::print);


        // IntStream.of(5,7,2,17).filter(e-> e > 10).max().ifPresent(System.out::print);

        // System.out.println(IntStream.of(5,7,2,17).sum());
